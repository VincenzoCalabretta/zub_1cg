"""cc_toolchain_config for arm-none-eabi-gcc targeting the PL-hosted Cortex-M3.

The compiler prefix is captured at Bazel fetch time by env_ext.bzl.
"""

load("@arm_gcc_config_m3//:defs.bzl", "ARM_GCC_BIN", "ARM_GCC_INCLUDE_DIRS")
...
# Cortex-M3: Thumb-2 only (ARMv7-M has no ARM state), no hardware FP.
_CPU_FLAGS = [
    "-mcpu=cortex-m3",
    "-mthumb",
    "-mfloat-abi=soft",
...
def _impl(ctx):
    ...
    return cc_common.create_cc_toolchain_config_info(
        ...
        toolchain_identifier = "arm-none-eabi-cortex-m3",
...
arm_none_eabi_m3_toolchain_config = rule(
