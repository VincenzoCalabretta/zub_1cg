...
- `//orbtrace/firmware/vexriscv:trace_workload` is RV32IMAC-safe deterministic
  ITM/TPIU stimulus logic.
- `//orbtrace/firmware/a53:control_firmware` owns the control protocol,
...
- `//orbtrace/firmware/common:firmware_common` contains fixed-capacity TCP
